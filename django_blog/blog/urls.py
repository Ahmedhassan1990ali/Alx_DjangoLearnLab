...
from blog.views import (register,profile,home,
                ...
                CommentCreateView, search_posts, TaggedPostListView
)
...
urlpatterns = [
    ...
    path('post/<int:post_id>/comments/new/',CommentCreateView.as_view(), name="comment_create"),#"post/<int:pk>/comments/new/"
